...
import CryptoWidget from '@/components/block/widget/crypto.vue'
...
export default class extends Vue {
  ...
  render(h): VNode {
    return h('div', { class: this.classes }, [ h('component', { is: this.block.component, props: { settings: this.block.settings } }) ])
  }
